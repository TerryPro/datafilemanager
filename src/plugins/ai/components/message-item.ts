...
export class MessageItem {
   ...
   */
  static render(props: MessageItemProps): HTMLElement {
   ...
   */
  private static renderUserMessage(message: ChatMessage): HTMLElement {
    const msg = createElement('div', 'ai-sidebar-message ai-sidebar-message-user');
  ...
  private static renderAIMessage(
    ...
    const msg = createElement('div', 'ai-sidebar-message ai-sidebar-message-ai');
   ...
   */
  private static renderSystemMessage(message: ChatMessage): HTMLElement {
    const msg = createElement('div', 'ai-sidebar-message ai-sidebar-message-system');
   ...
   */
  private static getModeLabel(message: ChatMessage): string {
